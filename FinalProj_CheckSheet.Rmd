...
(A) .Rmd Line number(s) for general data wrangling: 
    61-79, 86-88, 118-121, 140-142, 161-163, 173-177, 189-192, 204-205, 213-214, 226-227 
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  
    108-109, 151-154, 178-180, 193-195, 206-207, 215-216, 228-229, 238-239

(B) .Rmd Line number(s) for use of multiple aesthetics:  
    108-109, 152-153, 178-180, 193-195, 206-207, 215-217, 228-230, 238-239
